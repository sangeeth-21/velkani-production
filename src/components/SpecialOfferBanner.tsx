...
import { Tag, ShoppingBag, Box, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="px-4 py-3 mb-4 animate-fade-in">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white h-full min-h-[180px]">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-sky-600 text-white h-full min-h-[180px]">
