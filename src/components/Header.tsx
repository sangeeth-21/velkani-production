...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass shadow-sm animate-fade-in h-[30vh] flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 py-2">
        <a href="https://wa.me/1234567890" className="flex items-center text-sm">
          ...
          <span className="mr-1">{t('contact_whatsapp')}</span>
          <span>1234567890</span>
        </a>
        
        <a href="tel:1234567890" className="flex items-center text-sm">
          <Phone className="h-4 w-4 mr-1" />
          <span className="mr-1">{t('contact_phone')}</span>
          <span>1234567890</span>
        </a>
      </div>
    </header>
